...
export const Skill = () => {
  ...
  return (
    <section id="skill" className="lg:p-12 max-sm:mt-24 max-lg:mt-24">
      <h1 className="font-bold pb-2 max-sm:pt-6 max-sm:p-2 max-sm:sticky max-sm:top-0  max-sm:pl-4 max-sm:bg-gradient-to-r from-[#000428] to-[#072f52]">SKILL</h1>
      <div className="judul flex justify-evenly bg-black max-sm:ml-4 max-sm:mr-4 text-white lg:p-4 max-sm:py-2 max-lg:py-4 rounded-t-md lg:text-xl lg:font-bold">
      ...
      {option === 0 && (
        <div className="teknologi flex justify-center items-center h-96 bg-[rgb(10,17,44)] rounded-b-xl max-sm:ml-4 max-sm:mr-4">
      ...
      {option === 1 && (
        <div className="teknologi flex justify-center items-center h-96 bg-[rgb(10,17,44)] max-sm:ml-4 max-sm:mr-4 rounded-b-xl">
          <ul className="flex flex-col text-lg font-medium text-[rgb(85,198,169)]">
