...
export const About = () => {
  return (
    <section id="about" className="lg:p-12 ">
      <h1 className="font-bold pb-2 y max-sm:pt-6  max-lg:pl-6 max-lg:pr-6 max-sm:sticky max-sm:top-0 max-lg:w-full max-sm:bg-gradient-to-r from-[#000428] to-[#072f52]">ABOUT</h1>
      <p className="p1 mb-5 max-sm:m-6 max-lg:pl-6 max-lg:pr-6">
      ...
      <p className="p2 max-sm:m-6 max-lg:pl-6 max-lg:pr-6">
