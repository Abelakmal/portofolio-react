...
export const About = () => {
  return (
    <section id="about" className="lg:p-12 max-lg:p-5">
      <h1 className="font-bold pb-2 y max-sm:pt-6 max-sm:pl-4 max-lg:w-full max-sm:bg-gradient-to-r from-[#000428] to-[#072f52]">ABOUT</h1>
